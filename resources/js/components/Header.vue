            ...
            <div class="md:flex md:items-center md:justify-between">
                <div class="flex items-center justify-between">
                    <div class="text-xl font-semibold text-gray-700">
                        <a class="text-2xl font-bold text-gray-800 transition-colors duration-200 transform dark:text-white lg:text-3xl hover:text-gray-700 dark:hover:text-gray-300" href="#">Carnival</a>
                    </div>
                ...
                <div class="flex-1 md:flex md:items-center md:justify-between">
                    ...
                    <div class="flex items-center mt-4 md:mt-0">
                        ...
                        <div>
                        <button @click="dropDownRef=!dropDownRef" type="button" class="relative flex items-center focus:outline-none" aria-label="toggle profile dropdown">
                            <div class="dropdown w-8 h-8 overflow-hidden border-2 border-gray-400 rounded-full">
                      ...
                      <div  v-if="dropDownRef" class="absolute right-0 z-20 w-48 py-2 mt-2 bg-white rounded-md shadow-xl dark:bg-gray-800">
